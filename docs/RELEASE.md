...
4. Use a tag with the `v` prefix, for example `v1.0.0-B7`.
...
.\scripts\package-release.ps1 -Version 1.0.0-B7 -RequireInstaller
```
...
git tag -a v1.0.0-B7 -m "Release Android TV Manager 1.0.0-B7"
git push origin v1.0.0-B7
```

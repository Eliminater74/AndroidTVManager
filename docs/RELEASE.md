...
4. Use a tag with the `v` prefix, for example `v1.0.0-B6`.
...
.\scripts\package-release.ps1 -Version 1.0.0-B6 -RequireInstaller
```
...
git tag -a v1.0.0-B6 -m "Release Android TV Manager 1.0.0-B6"
git push origin v1.0.0-B6
```

...
The current version is `1.0.0-B5`. Keep the UI flashy but legible: dark navy/black surfaces, cyan and violet accents, clear sidebar navigation, restrained animation, strong focus states, and a useful About page. Preserve native WPF behavior and accessibility.

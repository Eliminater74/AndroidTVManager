...
public static class DeepInspectionCatalog
{
    ...
    public static IReadOnlyList<InspectionProbe> Probes { get; } = Array.AsReadOnly<InspectionProbe>([
        ...
        new("cpu-frequency", "Kernel / hardware", ["shell", "cat", "/sys/devices/system/cpu/cpu0/cpufreq/scaling_cur_freq"]),
        new("cpu-max-frequency", "Kernel / hardware", ["shell", "cat", "/sys/devices/system/cpu/cpu0/cpufreq/cpuinfo_max_freq"]),
        new("cpu-governor", "Kernel / hardware", ["shell", "cat", "/sys/devices/system/cpu/cpu0/cpufreq/scaling_governor"]),
